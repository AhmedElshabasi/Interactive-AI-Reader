/** Remove lone UTF-16 surrogates (keep valid pairs only). */
...
/** Force a UTF-8-safe string (TextEncoder replaces any remaining ill-formed sequences). */
...
/** Clean text before Piper / espeak (PDF + LLM output often contain lone surrogates). */
...
/** Split into Piper-friendly segments (shorter lines = fewer espeak failures). */
